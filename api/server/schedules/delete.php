...
try {
    ...
    pteroRequireServerPermission($serverIdentifier, 'schedule.delete');

    session_write_close();

    $result = pteroDeleteSchedule($serverIdentifier, $scheduleId);
    ...
    pteroJsonError(500, $message !== '' ? $message : 'Failed to delete schedule.');
}