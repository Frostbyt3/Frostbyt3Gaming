...
<aside class="fbg-dashboard-sidebar">
    ...
    <nav class="fbg-dashboard-sidebar-nav" aria-label="Sidebar navigation">
        <div class="fbg-dashboard-sidebar-group">
            ...
            <a href="<?php echo htmlspecialchars($fbgSidebarDashboardUrl, ENT_QUOTES, 'UTF-8'); ?>" class="fbg-admin-nav-link <?php echo $fbgSidebarCurrent === 'dashboard' ? 'active' : ''; ?>">
        ...
        <div class="fbg-dashboard-sidebar-group">
            ...
            <a href="<?php echo htmlspecialchars($fbgSidebarAccountUrl, ENT_QUOTES, 'UTF-8'); ?>" class="fbg-admin-nav-link <?php echo $fbgSidebarCurrent === 'account' ? 'active' : ''; ?>">
                <i class="fas fa-user"></i>
                <span>User Profile</span>
            </a>
            <a href="<?php echo htmlspecialchars($fbgSidebarCreditUrl, ENT_QUOTES, 'UTF-8'); ?>" class="fbg-admin-nav-link <?php echo $fbgSidebarCurrent === 'credit' ? 'active' : ''; ?>">
